...
?>
<div class="discuss-item-location fd-cf mt-15 postLocation" data-id="<?php echo $post->id;?>" id="location-<?php echo $post->id;?>">
<hr />
	<div class="ph-10">
		<div class="fd-cf discuss-item-location-hd">
