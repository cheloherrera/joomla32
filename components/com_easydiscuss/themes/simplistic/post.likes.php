...
<?php if( ( $system->config->get( 'main_likes_discussions' ) && !$post->parent_id ) || ( $system->config->get( 'main_likes_replies' ) && $post->parent_id ) ){ ?>
	...
	<div class="discuss-likes discussLikes" data-postid="<?php echo $post->id;?>" data-registered-user="<?php echo $system->my->id ? "true" : "false"; ?>">
		<a href="javascript:void(0);" class="btn btn-likes<?php echo $isLiked ? ' btnUnlike' : ' btnLike';?>" href="javascript:void(0);" rel="ed-tooltip" data-placement="top" 
			data-original-title="<?php echo $system->my->id ? JText::_( $message , true ) : JText::_('COM_EASYDISCUSS_PLEASE_LOGIN_TO_LIKE');?>"
		>
