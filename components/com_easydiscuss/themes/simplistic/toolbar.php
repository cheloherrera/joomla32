											...
											<ul class="unstyled discuss-user-links">
												<li>
													<?php if( $system->config->get( 'layout_avatarIntegration' ) == 'jomsocial' && !$system->config->get( 'integration_toolbar_jomsocial_profile' ) ){ ?>
														<a href="<?php echo DiscussRouter::_( 'index.php?option=com_easydiscuss&view=profile' ); ?>"><i class="icon-user"></i> <?php echo JText::_( 'COM_EASYDISCUSS_VIEW_MY_PROFILE' );?></a>
													<?php } else { ?>
														<a href="<?php echo $system->profile->getLink(); ?>"><i class="icon-user"></i> <?php echo JText::_( 'COM_EASYDISCUSS_VIEW_MY_PROFILE' );?></a>
													<?php } ?>
												</li>

												<?php if( !$system->config->get( 'layout_avatarLinking' ) ||
														$system->config->get( 'layout_avatarIntegration') == 'default' ||
														$system->config->get( 'layout_avatarIntegration') == 'gravatar' ||
														( $system->config->get( 'layout_avatarIntegration' ) == 'jomsocial' && !$system->config->get( 'integration_toolbar_jomsocial_profile' ) )
													 ){ ?>
												<li>
