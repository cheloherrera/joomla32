...
$authorised = JFactory::getUser()->authorise('core.manage', 'com_ats');
$catid = $this->input->getInt('catid', 0);
if ($catid)
{
	$authorised = $authorised || JFactory::getUser()->authorise('core.manage', 'com_ats.category.' . $catid);
}
if(!$item->enabled || !$authorised) return;
