...
class AtsHelperEmail
{
	...
	{
		if(!class_exists('AtsWorkaroundMailer', false)) {
			require_once JPATH_ADMINISTRATOR.'/components/com_ats/assets/mailer/mailer.php';
		}

		$mailer = new AtsWorkaroundMailer();
