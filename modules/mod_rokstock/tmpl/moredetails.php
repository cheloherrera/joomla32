<?php
/**
 * @version   $Id: moredetails.php 6809 2013-01-27 22:04:15Z btowles $
...
if (preg_match("/\+/", $tickers["c"])) $direction = "plus"; else $direction = "minus";
...
<div class="rokstock-tip-inner">
	...
	<div class="content">
		...
		<div class="trade-change row">
			...
			<span class="<?php echo $direction; ?>"><?php echo $tickers['c']; ?> (<?php echo $tickers['cp']; ?>
				%)</span></span>
		</div>
