<?php
/**
 * @version   $Id: chart.php 6809 2013-01-27 22:04:15Z btowles $
...
if (!isset($size) || $size == "small") {
	$size      = "small";
	$chartsize = array(212, 102);
} else if ($size == "medium") $chartsize = array(300, 150); else if ($size == "large") $chartsize = array(400, 200);
