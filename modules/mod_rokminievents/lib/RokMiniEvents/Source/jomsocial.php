<?php
/**
 * @version   $Id: jomsocial.php 9609 2013-04-24 02:34:17Z steph $
...
class RokMiniEventsSourceJomSocial extends RokMiniEvents_SourceBase
{
	function getEvents(&$params)
	{
		...
		foreach ($rows as $row) {
            ...
            $tz = $conf->get('offset');
            $tz_offset = RokMiniEvents::_get_timezone_offset($tz, false);
			...
			$event = new RokMiniEvents_Event($startdate, $enddate, $row->title, $row->description, $link);
