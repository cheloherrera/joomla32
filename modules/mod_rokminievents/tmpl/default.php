				...
				<li class="rokminievents-item<?php echo (!$i) ? ' rokminievents-item-first' : '';?>">
					<div class="rokminievents-item-padding">
						...
						<div class="rokminievents-desc">
							...
							<span class="rokminievents-date"><?php echo $start ?></span>
							<?php endif; ?>
							<?php if(!$event->isAllDay()): ?><span class="rokminievents-time"><?php echo $time ?></span>
                            <?php else:?><span class="rokminievents-time"><?php echo 'All Day'; ?></span>
                            <?php endif;?>
