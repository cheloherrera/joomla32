...
<div class="js-module js-mod-photos">
	<div class="app-box-content">
		...
		?>
			...
			<div class="js-col3 bottom-gap">
				<a class="thumbnail" href="<?php echo CRoute::_('index.php?option=com_community&view=photos&task=photo&albumid=' . $row->albumid .  '&userid=' . $row->user->id . '&photoid=' . $row->id);?>">
