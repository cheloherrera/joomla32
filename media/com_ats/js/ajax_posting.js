...
akeeba.jQuery(document).ready(function($)
{
    ...
    var options = {
        dataType : 'json',
        url : 'index.php?option=com_ats&view=post&task=save&tmpl=component&format=json',
        ...
        success : function(json){
	        ...
	        else
	        {
                ...
                akeeba.jQuery.ajax('index.php?option=com_ats&view=post&layout=single&tmpl=component&render.toolbar=0', {
                    cache : false,
			        data : {
				        id : json.id,
				        format : 'raw',
    ...
    akeeba.jQuery('.reloadTicketList').click(function()
    {
        ...
        akeeba.jQuery.ajax('index.php?option=com_ats&view=posts&layout=threaded&tmpl=component&render.toolbar=0', {
            cache : false,
            data  : {
                format        : 'raw',
