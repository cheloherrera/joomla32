    ...
    private function putFile($absolute_filename, $directory, $basename)
    {
        ...
        if($directory)
        {
            ...
            foreach($parts as $part)
            {
                ...
                {
                    AEUtilLogger::WriteLog(_AE_LOG_DEBUG, "Remote path $checkPath does not exists");
                    ...
                    {
                        AEUtilLogger::WriteLog(_AE_LOG_DEBUG, "There was an error while creating the remote folder $checkPath");
                        return false;
                    }
