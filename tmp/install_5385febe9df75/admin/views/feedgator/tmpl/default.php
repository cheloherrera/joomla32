		...
		<tr>
			<td valign="top" width="55%">
				<div id="cpanel">
					...
					echo $this->defaults ? FeedgatorHelper::renderCpanel(array('href'=>'#'),array('src'=>'components/com_feedgator/images/cpanel/ok.png','alt'=>JText::_('FG_DEFAULTS')),JText::_('FG_DEFAULTS')) : FeedgatorHelper::renderCpanel(array('href'=>'index.php?option=com_feedgator&task=editdefault'),array('src'=>'components/com_feedgator/images/cpanel/warning.png','alt'=>JText::_('FG_NO_DEFAULTS')),JText::_('FG_NO_DEFAULTS'));
					?>
				</div>
			</td>
