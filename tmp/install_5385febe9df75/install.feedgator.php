...
$installer->install($src.DS.'plg_feedgator_system');
$installer->install($src.DS.'plg_fg_content');
$installer->install($src.DS.'plg_fg_k2');
...
if(J_VERSION > 1.5) {
	echo '<style>'.file_get_contents('components/com_feedgator/css/install.css').'</style>';
}
