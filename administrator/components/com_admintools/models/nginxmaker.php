...
gzip_types      text/plain text/html text/xml text/css application/xml application/xhtml+xml application/xml+rss application/rss+xml application/x-javascript application/javascript text/javascript application/json text/xml application/xml;
gzip_buffers    16 8k;
...
location = $rewritebaseSlash/administrator {
	rewrite ^ $rewritebaseSlash/administrator/index.php last;
}
location = $rewritebaseSlash/administrator/ {
	rewrite ^ $rewritebaseSlash/administrator/index.php last;
}
...
location ~* ^$rewritebaseSlash/(cache|includes|language|logs|tmp)/ {
	return 403;
}

# Allow access to the front-end index.php file
location = $rewritebaseSlash/ {
	rewrite ^ $rewritebaseSlash/index.php last;
}
location = $rewritebaseSlash/ {
	rewrite ^ $rewritebaseSlash/index.php last;
}
