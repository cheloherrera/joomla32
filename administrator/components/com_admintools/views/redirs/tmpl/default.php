...
<form name="adminForm" id="adminForm" action="index.php" method="post">
	...
	<table class="adminlist table table-striped" id="itemsList">
		...
		<tr>
			...
			<?php endif; ?>
			<td>
				<?php echo AdmintoolsHelperSelect::booleanlist('keepurlparams', array('onchange' => 'this.form.submit();'), $this->getModel()->getState('keepurlparams', '')) ?>
			</td>
			<td>
		...
		<?php if ($count = count($this->items)): ?>
			...
			foreach ($this->items as $item):
				...
				<tr>
					...
					<?php endif; ?>
					<td>
						<?php echo ($item->keepurlparams) ? JText::_('JYES') : JText::_('JNO'); ?>
					</td>
					<td>
