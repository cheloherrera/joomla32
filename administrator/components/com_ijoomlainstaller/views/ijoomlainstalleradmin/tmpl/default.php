...
//$list_components = array("adagency"=>"iJoomla Ad Agency", "guru"=>"Guru", "seo"=>"iJoomla SEO", "publisher"=>"Publisher");

if(version_compare(JVERSION, '3.0', 'ge')){
	$list_components = array("adagency"=>"iJoomla Ad Agency", "seo"=>"iJoomla SEO", "community_std"=>"JomSocial Standard", "community_pro"=>"JomSocial Professional", "community_dev"=>"JomSocial Developer");
}
else{
                            ...
                            <td style="text-align:right; vertical-align: middle !important;">
                            	<?php
                                	if($installed_version == ""){// not installed
										...
										$link = "";
										if($key == "adagency"){
											$link = "http://adagency.ijoomla.com/pricing/?utm_source=customer&utm_medium=installer&utm_content=adagency&utm_campaign=professional";
										}
										elseif($key == "seo"){
											$link="http://seo.ijoomla.com/pricing/?utm_source=customer&utm_medium=installer&utm_content=seo&utm_campaign=professional";
										}
