		...
		switch($component){
			...
			case "community_std" : {
				...
				if(!file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_std.php") && 
				   !file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_pro.php") && 
				   !file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_dev.php")){
					...
					if(file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_pro.php") || file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_dev.php")){
						return "";
					}
				}
			...
			case "community_pro" : {
				$component = "community";
				if(!file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_pro.php")){
					return "";
				}
				
				if(file_exists(JPATH_SITE.DIRECTORY_SEPARATOR."administrator".DIRECTORY_SEPARATOR."components".DIRECTORY_SEPARATOR."com_".$component.DIRECTORY_SEPARATOR."helpers".DIRECTORY_SEPARATOR."community_dev.php")){
					return "";
				}
