...
class DPCalendarHelper
{
	...
	public static function renderEvents (array $events = null, $output, $params = null, $eventParams = array())
	{
		...
		foreach ($events as $event)
		{
			...
			$variables['description'] = JFactory::getDocument() instanceof JDocumentHTML && JFactory::getApplication() instanceof JApplication ? JHTML::_(
					'content.prepare', $event->description) : $event->description;
