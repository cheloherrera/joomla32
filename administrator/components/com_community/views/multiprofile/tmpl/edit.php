					...
					<tbody>
						<tr>
							<td width="300" class="key">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_TITLE_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_TITLE' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_DESCRIPTION_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_DESCRIPTION' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_PUBLISHED_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_PUBLISHED' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_REQUIRE_APPROVALS_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_REQUIRE_APPROVALS' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_ALLOW_GROUP_CREATION_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_ALLOW_GROUP_CREATION' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_ALLOW_EVENT_CREATION_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_ALLOW_EVENT_CREATION' ); ?></span>
							</td>
							<td valign="top">
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_MULTIPROFILES_LOCK_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_MULTIPROFILES_LOCK' ); ?></span>
							</td>
							<td valign="top">
								<?php echo JHTML::_('select.booleanlist' , 'profile_lock' , null , $this->multiprofile->profile_lock , JText::_('COM_COMMUNITY_YES_OPTION') , JText::_('COM_COMMUNITY_NO_OPTION') ); ?>
							</td>
						</tr>
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_WATERMARK_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_MULTIPROFILE_WATERMARK' ); ?></span>
							</td>
							<td valign="top">
								<div style="float: left;">
									...
									<?php if( !empty( $this->multiprofile->watermark) ){ ?>
										<img src="<?php echo $this->multiprofile->getWatermark();?>" style="border: 1px solid #eee;" /><br>
						...
						<tr>
							<td width="300" class="key" valign="top">
								<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_MULTIPROFILE_WATERMARK_POSITION_TIPS'); ?>"><?php echo JText::_( 'COM_COMMUNITY_MULTIPROFILE_WATERMARK_POSITION' ); ?></span>
							</td>
							<td valign="top">
