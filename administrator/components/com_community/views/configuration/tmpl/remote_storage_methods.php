		...
		<tbody>
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_PHOTOS_TIPS'); ?>">
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_VIDEOS_TIPS'); ?>">
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_PROFILEAVATARS_TIPS'); ?>">
			...
			<tr>
				<td width="300" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_GROUPAVATARS_TIPS'); ?>">
			...
			<tr>
				<td width="200" class="key">
					<span class="hasTip" title="::<?php echo JText::_('COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_FILES_TIPS')?>"> <?php echo JText::_( 'COM_COMMUNITY_CONFIGURATION_REMOTE_STORAGE_FILES' )?></span>
				</td>
				<td valign="top">
