<?php
/**
 * @version   $Id: index.php 18736 2014-02-13 12:26:18Z arifin $
...
?>
<div class="sprocket-features layout-animation<?php echo ($parameters->get('features_show_arrows')=='onhover') ? " arrows-onhover" : ""; ?>" data-animation="<?php echo $parameters->get('module_id'); ?>">
	...
	<div class="sprocket-features-pagination<?php echo !$parameters->get('features_show_pagination') ? '-hidden' : '';?>">
		...
		<?php $i = 0; foreach ($items as $item): ?>
			<?php
				...
				$i++;
			?>
	    	<li<?php echo $class; ?> data-animation-pagination="<?php echo $i; ?>"><span><?php echo $i; ?></span></li>
		<?php endforeach; ?>
		</ul>
	</div>
</div>
